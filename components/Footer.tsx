...
export default function Footer() {
  ...
  return (
    <footer id="contactus" className="bg-gradient-to-br from-gray-900 via-gray-800 to-gray-900 text-gray-300 py-16 mt-6">
                  ...
                  <div className="space-y-4 text-sm">
                    <div className="flex items-start space-x-3 hover:text-orange-300 transition-colors">
                      ...
                      <span className="leading-relaxed">
                       EC 125/127,   Deptartment of Electronics and Communication,
                        <br />
